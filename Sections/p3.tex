...
\subsection{Pratique du jeu vidéo et santé mentale}
...
\begin{figure}[H]
    ...
    \caption{Répartition des individus selon la pratique du jeu vidéo prioritaire par catégorie ADRS.}
    \label{fig:jv_adrs}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/P3/JV_controle.png}
    \caption{Répartition des individus selon le controle de la pratique de jeux vidéo par catégorie ADRS.}
    \label{fig:jv_sante}
\end{figure}
