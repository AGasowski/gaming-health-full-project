...
consommation de jeux des jeunes. Nous ne définirons pas dans la suite quels
individus parmi les participants sont en proie à une addiction selon les critères
de l'Organisation mondiale de la santé (OMS), car le jeu de données ne nous le permet pas.
Nous entendons par comportement addictif une personne qui joue de manière très fréquente et répétée.
