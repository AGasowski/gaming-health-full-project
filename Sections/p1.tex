...
\begin{figure}[H]
    ...
    \textit{La modalité "jamais" trop importante, a été enlevée du graphique
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{Images/freq_par_sexe.pdf}
    \caption{Fréquence de jeu par genre}
    \label{fig:frequence_jeu_par_genre}
