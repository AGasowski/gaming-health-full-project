...
En effet , 18,9\% 
d'entre eux en ont gratté au moins dans les 12 derniers mois.
Ils sont bienplus nombreux que ceux ayant joué au poker puisque
...
beaucoups de jeunes y ont joué, cela ne signifie pas pour autant
...
(Figure \ref{frequence 3JA}). Le ticket à gratter est certes plus d'amateurs
...
l’année un poste de consommation relativement important. 
La médiane des mises habituelles renseignées par les sondés est de 10€.
Les mises annuelles de certains représentent donc d’importantes sommes pour les joeurs réguliers.
C'est d’autant plus le cas  puisque plus un joueur pari, plus les sommes pariées sont en moyenne
...
T TRAN et al, 2024)\cite{gambling}. Les hommes jouent donc 1,3 fois plus que les femmes.
...
(Samuel Coavoux, 2019)\cite{gamer}. En 2011, 29,5\% des garçons de 17 ans jouent tous les jours aux jeu vidéo, alors que c'est
