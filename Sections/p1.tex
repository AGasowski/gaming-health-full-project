...
déclarent le faire majoritairement sur internet (Source: Enquête ESCAPAD 2022).
...
\begin{figure}[H]
    ...
    \textit{Note de lecture: 17,5\% des interrogés jouent à des jeux vidéo tous
...
vidéo plusieurs fois par semaine (34\%) qu'une seule fois par semaine (12\%).
...
La pratique du jeu vidéo est encore plus genrée que celle des jeux d'argent. Les
...
ESCAPAD 2022 semble indiquer que la fréquence de jeu vidéo est moins genrée
...
fréquence de jeu vidéo s'homogénise selon le genre, cela ne signifie pas
qu'elles se ressemblent de plus en plus. Les femmes ne jouent pas aux mêmes jeux
