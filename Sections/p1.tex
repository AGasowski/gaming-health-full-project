...
importantes (Tableau \ref{mises paris}). Un test du khi\textsuperscript{2}
($p-value = 8,8 \times 10^{-12}$) nous confirme qu'il y a effectivement un lien
statistique entre la fréquence de jeu d'argent et la mise habituelle (voir
...
\begin{figure}[H]
    ...
    \caption{Tableau des résidus standardisés entre les variables de fréquence
...
Apres une brève étude de la consommation des joueurs, il est
...
Ce n'est pas seulement que les hommes jouent plus souvent aux jeux
...
En plus du sexe, d'autres variables sociodémographiques peuvent
