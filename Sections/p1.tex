...
\begin{figure}[H]
    ...
    50 € est sur-représentée, alors que celle des individus jouant moins
    d'une fois par semaine est sous-représentée.}\\
    \textit{La règle choisie pour évaluer les valeurs des résidus est énoncée
...
peut observer une féminisation de ce secteur (Samuel Coavoux,
2019 \cite{gamer}). En 2011, 29,5\% des garçons de 17 ans jouent tous les jours
aux jeux vidéo, alors que c'est seulement 3\% pour les filles du même âge
