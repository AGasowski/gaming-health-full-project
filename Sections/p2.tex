...
\begin{center}\includegraphics[width=1\textwidth]{Images/Freq_JV_sport.png}\\[2.0 cm]
...
\begin{center}\includegraphics[width=1\textwidth]{Images/Freq_JA_medecin.png}\\[2.0 cm]
...
\begin{center}\includegraphics[width=1\textwidth]{Images/Freq_JV_medecin.png}\\[2.0 cm]
