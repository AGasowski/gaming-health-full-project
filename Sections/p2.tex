...
L'IMC est également un marqueur de la santé physique, faisant le lien entre la taille et le poids
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/p2-graphe1-freqJAimc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/p2-graphe2-freqJVimc.png}
    \caption{Fréquence de jeu et IMC.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/p2-graphe3-comparaisonJAetPSetJAsansPS.png}
...
Ce résultat est à mettre en parallèle avec celui concernant seulement les joueurs de paris sportifs,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/p2-graphe4-joueurJVsport.png}
    \caption{Répartition des sportifs parmi les joueurs.}
    \label{fig:freq_joueur_JV_sport}
\end{figure}

Les sportifs quotidiens sont de nouveau ceux qui jouent le plus aux jeux vidéos (85,6\% d'entre eux
...
de sportifs. Cette étude ne nous permet pas d'établir un lien entre le comportement des individus
vis à vis du sport et des jeux vidéos.\\

Il est également intéressant de comprendre le comportement des individus en ce qui concerne la prise
de rendez-vous chez le médecin, qui est un indicateur d'un individu qui prend soin de sa santé ou
non. 86,8\% des individus ayant répondu au questionnaire sont allé chez le
médecin dans l'année. Ce chiffre varie si on étudie chaque catégorie de joueurs.
