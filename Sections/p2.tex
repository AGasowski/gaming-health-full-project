...
Les individus en obésité, au-delà de jouer en plus grande proportion aux jeux
d'argent, jouent également plus fréquemment. En effet, on compte parmi eux
5,4\% de joueurs hebdomadaires. De même, les individus en insuffisance
pondérale jouent moins fréquemment, avec 2,6\% de joueurs hebdomadaires.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/P2/JVfreqsimp2_IMC.png}
    \caption{Fréquence de jeu et IMC.}
    \label{fig:freq_JV_IMC}
\end{figure}

En revanche, la différence est plus visible lorsqu'il s'agit de la fréquence de
jeu. Les individus en obésité comptent parmi eux plus d'un quart de joueurs
quotidiens (26,6\%), plus que toute autre catégorie d'IMC. Ce sont ensuite les
individus en insuffisance pondérale qui jouent le plus au quotidien (20,6\%
...
joueurs plus fréquents de jeux d'argent. Ils se démarquent en ce qui concerne
les jeux vidéos.
...
dire que les deux activités sont liées, et c'est bien le cas puisqu'elles
