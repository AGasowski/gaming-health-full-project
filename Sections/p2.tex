...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/p2-1-joueurJA.png}
    \caption{Fréquence de jeu et IMC.}
    \label{fig:freq_JA_IMC}
\end{figure}

On remarque une légère variation de la pratique de jeux d'argent des individus
en fonction de leur catégorie d'IMC. En effet, les individus en obésité ont une
plus grande tendance à jouer aux jeux d'argent, avec 30,5\% de joueurs parmi
eux. A l'opposé, les individus en insuffisance pondéral sont ceux qui jouent le
moins avec 27,3\% de joueurs. Entre les deux se trouvent les individus à la
