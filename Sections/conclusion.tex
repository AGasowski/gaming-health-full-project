...
d'individus du même âge, alors que la consommation de jeux est une pratique
très différente d'une génération à l'autre. On peut aussi supposer que les
résultats auraient été très différents et que des questions plus précises sur
la santé auraient ouvert de nouvelles portes. Il aurait été intéressant de
connaître les symptômes les plus récurrents chez chacun (maux de ventre,
insomnie) et d'ainsi pouvoir les étudier.
